...
export default function Acara() {
  const DateFrame = ({ t1, t2, t3, t4, t5, t6, t7 }) => (
    ...
    >
      <div className="relative">
        ...
        <div className="w-20 h-20 rounded-full bg-white shadow-lg font-bold flex items-center justify-center border-4 border-indigo600 text-4xl">
          {t1}
        </div>
  ...
  return (
    ...
    >
      <BackgroundImage src="/templates/3/background/3.png" />

      <ContainerTemplate>
        <motion.h1
          variants={fadeIn}
          className="text-center text-indigo700 font-salsa text-3xl"
        >
          Rangkaian Acara
        </motion.h1>

...
export default function LoveStory() {
  return (
    ...
    >
      <BackgroundImage src="/templates/3/background/4.png" />
          ...
          <div className="space-y-0">
            <div className="grid grid-cols-2 relative gap-x-3">
              ...
              <div className="absolute h-full w-1 bg-gray-700 rounded-t-full left-1/2 transform -translate-x-1/2 z-10">
                <div className="absolute w-4 h-12 rounded-full bg-indigo300 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"></div>
              </div>
